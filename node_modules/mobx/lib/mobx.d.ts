...
declare function autorun(view: (r: IReactionPublic) => any, scope?: any): IReactionDisposer;
declare function autorun(name: string, view: (r: IReactionPublic) => any, scope?: any): IReactionDisposer;
...
declare function autorunAsync(name: string, func: (r: IReactionPublic) => any, delay?: number, scope?: any): IReactionDisposer;
declare function autorunAsync(func: (r: IReactionPublic) => any, delay?: number, scope?: any): IReactionDisposer;
